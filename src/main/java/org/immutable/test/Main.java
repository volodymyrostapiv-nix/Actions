...
import org.immutable.test.User;
import org.immutable.test.StagedUser;
import org.immutable.test.Password;
import org.immutable.test.StyledUser;
...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(user2 + ", salt: " + user2.getSalt()); System.out.println(user1.equals(user2));
        ...
        StagedUser stg1 = StagedUser.builder().username("login").password(Password.of("my-very-long-password")).build();
